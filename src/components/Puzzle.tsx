  ...
  return (
    <div className="flex flex-col items-center gap-14">
      <div className="flex gap-14">
        {shuffledPieces.slice(0, 2).map((piece, index) => (
          <Piece
            key={`${puzzleConfig.color}-top-${index}`}
      ...
      <div className="flex gap-14 items-center">
        <Piece
          key={`${puzzleConfig.color}-top-2`}
          color={puzzleConfig.color}
          piece={shuffledPieces[2]}
        />
        <div
          style={
            {
        ...
        <Piece
          key={`${puzzleConfig.color}-top-3`}
          color={puzzleConfig.color}
          piece={shuffledPieces[3]}
        />
      </div>

      <div className="flex gap-14">
        {shuffledPieces.slice(4, 6).map((piece, index) => (
          <Piece
